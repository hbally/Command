...
public final class CRC16X25Util {

    static int CRC16_CCITT_TABLE[] = {0x0000, 0x1189, 0x2312, 0x329b, 0x4624, 0x57ad, 0x6536, 0x74bf, 0x8c48, 0x9dc1,
    ...
    public static int crc_16_X25(byte[] bytes) {
        ...
        for (int i = 0; i < bytes.length; i++) {
            crc_reg = (crc_reg >> 8) ^ CRC16_CCITT_TABLE[(crc_reg ^ bytes[i]) & 0xFF];
        }
        return ~crc_reg;
    }
